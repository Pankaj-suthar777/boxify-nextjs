...
export function SelectWorkspace() {
  ...
  return (
    <div className="relative flex justify-center items-center">
      <div
        onClick={handleClick}
        className={`mx-2 flex items-center cursor-pointer rounded-lg transition-all duration-300 
          ${
            isOpen
              ? "bg-purple-50 outline outline-[3px] outline-purple-600"
              : "hover:bg-slate-100"
          } 
          transition-colors duration-300 ease-in-out p-2 min-w-[200px]`}
      >
        <Building2
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute mx-4 mt-1 w-[300px] bg-white border rounded-lg shadow-lg top-10 right-2 z-20 "
          ...
          >
            <ul className="">
              <li className="py-4 hover:bg-gray-100 cursor-pointer px-2">
                <div
